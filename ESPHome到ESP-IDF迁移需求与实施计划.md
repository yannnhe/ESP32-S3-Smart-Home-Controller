...
| 14 | 客厅灯按键 | 去抖后切换灯带 |
| 19 | 厨房火焰传感器 | 低有效；与原生 USB D- 冲突需确认 |
| 21 | 厨房风扇 | 高电平开，上电安全关闭 |
| 42 | 厨房蜂鸣器 | 低有效，上电保持关闭 |
...
- GPIO19 与原生 USB D- 复用；若保留原生 USB 下载/日志，火焰传感器需迁脚。
...
| P1 | 验证既有网络、MQTT、DHT、RSSI | HA 自动发现正确，重连后状态完整恢复 |
| P2 | 迁移 ADC 与火焰传感器 | 每路独立稳定，异常输入不崩溃 |
